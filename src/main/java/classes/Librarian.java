...
public class Librarian extends User {
  ...
  public boolean updateTotalBook(Book book, int totalBooks) {
    if (totalBooks < book.getBorrowedBooks()) {
      System.out.println("Số lượng sách đã mượn lớn hơn số lượng sách còn lại");
      return false;
    }
  ...
  public boolean deleteBook(Book book) {
    ...
    //Kiểm tra có ai mượn sách này không
  ...
  // Hàm thêm sách
  public boolean addBook(String title, String author, String isbn, String description,
      int totalBooks) {
...
//  // Hàm sửa số lượng sách ( Có thể không dùng )
...
//  }
  ...
  // Hàm xóa sách bằng isbn ( Có thể không dùng )
  public void deleteBookWithisbn(String isbn) {
    Book book = User.getBookByIsbn(isbn);
    if (book != null) {
      deleteBook(book); // Xóa sách khỏi cơ sở dữ liệu
